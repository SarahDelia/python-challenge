...
print(f"Greatest Increase in Profits: {(months[max_months])} (${max(change_list)})")

print(f"Greatest Decrease in Profits: {(months[min_months])} (${min(change_list)})")
...
with open(Output_file, 'w') as txt_file:
    ...
    txt_file.write(f"Greatest Increase in Profits: {(months[max_months])} (${max(change_list)})\n")
    txt_file.write(f"Greatest Decrease in Profits: {(months[min_months])} (${min(change_list)})\n")
